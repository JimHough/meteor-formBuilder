...
if((typeof FormBuilder.controllers.fbControllerBase) !== "object") FormBuilder.controllers.fbControllerBase = function(){};
//Use obj to shorten following lines
var obj = FormBuilder.controllers.fbControllerBase;
...
if(Meteor.isClient){
  ...
  obj.prototype.addViews = function(fieldName, formObj, schemaObj, position, parentID){
    ...
    schemaObj = normaliseSchema(schemaObj);
