...
if(Meteor.isClient){
  ...
  obj.prototype.addViews = function(fieldName, formObj, schemaObj, position, parentID){
    ...
    schemaObj = this.getSchemaDefaults(schemaObj);
...
if((typeof FormBuilder.controllers.fbControllerBaseMulti) !== "object") FormBuilder.controllers.fbControllerBaseMulti = obj;