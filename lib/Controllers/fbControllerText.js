...
if(Meteor.isClient){
  ...
  FormBuilder.controllers.fbControllerText.addViews = function(fieldName, formObj, schemaObj, position, parentID){
    ...
    schemaObj = _.pick(schemaObj, 'controller', 'view', 'labelText', 'unique', 'asYouType', 'optional', 'defaultValue', 'minLength', 'maxLength', 'filter', 'textarea');
