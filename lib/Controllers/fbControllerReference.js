...
obj.prototype.getSchemaDefaults = function () {
  ...
  baseObj.collection = '';
  baseObj.showAddBtn = true;
  baseObj.showScanBtn = true;
  baseObj.showListBtn = true;
  baseObj.addFormFilter = 0xFFFF;
  baseObj.addFormTitle = 'Enter details for the new item';
  return baseObj;
};
