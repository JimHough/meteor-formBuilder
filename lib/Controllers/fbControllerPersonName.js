...
if((typeof FormBuilder.controllers.fbControllerPersonName) !== "object") FormBuilder.controllers.fbControllerPersonName = function(){};

//Inherit from the base 'class'
var obj = FormBuilder.controllers.fbControllerPersonName;
...
if(Meteor.isClient){
  ...
  obj.prototype.addViews = function(fieldName, formObj, schemaObj, position, parentID){
    ...
    var baseResult = objBase.addViews(fieldName, formObj, schemaObj, position, parentID);
