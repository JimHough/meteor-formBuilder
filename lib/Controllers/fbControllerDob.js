...
if(Meteor.isClient){
  ...
  FormBuilder.controllers.fbControllerDob.getValue = function(fieldName, parentID, position){
  ...
  FormBuilder.controllers.fbControllerDob.setError = function(fieldName, parentID, position, message){
  ...
  FormBuilder.controllers.fbControllerDob.addViews = function(fieldName, formObj, schemaObj, position, parentID){
    ...
    if (FormBuilder.helpers.isInt(schemaObj.minAge)) schemaObj.maxValue = moment().subtract('years', schemaObj.minAge).format('YYYY-MM-DD');
    if (FormBuilder.helpers.isInt(schemaObj.maxAge)) schemaObj.minValue = moment().subtract('years', schemaObj.maxAge).format('YYYY-MM-DD');
