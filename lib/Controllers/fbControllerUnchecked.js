...
if(Meteor.isClient){
  FormBuilder.controllers.fbControllerUnchecked.getValue = function(fieldName, parentID, position, callback){
    callback({visible:false,  value:null});
  };
  FormBuilder.controllers.fbControllerUnchecked.setValue = function(fieldName, parentID, position, value){
  };
  FormBuilder.controllers.fbControllerUnchecked.setError = function(fieldName, parentID, position, errors){
  };
