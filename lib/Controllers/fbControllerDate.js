...
if(Meteor.isClient){
  ...
  FormBuilder.controllers.fbControllerDate.getValue = function(fieldName, parentID, position, callback){
  ...
  FormBuilder.controllers.fbControllerDate.setError = function(fieldName, parentID, position, errors){
