...
if(Meteor.isClient){
  ...
  FormBuilder.controllers.fbControllerQRCode.getValue = function(fieldName, parentID, position){
  ...
  FormBuilder.controllers.fbControllerQRCode.setError = function(fieldName, parentID, position, message){
