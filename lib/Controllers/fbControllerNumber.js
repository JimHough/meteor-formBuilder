...
if(Meteor.isClient){
  ...
  FormBuilder.controllers.fbControllerNumber.getValue = function(fieldName, parentID, position){
  ...
  FormBuilder.controllers.fbControllerNumber.setError = function(fieldName, parentID, position, message){
