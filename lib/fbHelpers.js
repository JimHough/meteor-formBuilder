...
FormBuilder.setHook = function(hookID, type, func){
  if((typeof type !== 'string') || (typeof hooks[type] === 'undefined')){
    console.warn('FormBuilder.addHook called with invalid type:' + type);
    return;
  }
  if(typeof func !== 'function'){
    console.warn('FormBuilder.addHook called with invalid function');
    return;
  }
  if(typeof hookID !== 'string'){
    console.warn('FormBuilder.addHook called with invalid hookID');
    return;
  }
