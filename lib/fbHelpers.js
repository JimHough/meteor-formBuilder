...
FormBuilder.helpers.getCurrentValues= function(formID, callback){
  ...
  var position = {value:0};
  var fields = _.keys(_.omit(collection.schema,["schemaPath"]));
...
//Get a field with a string path
//Object.resolve("document.body.style.width")
//Object.resolve("style.width", document.body)
//Object.resolve("part3.0.size", someObject) 
// a safe flag makes Object.resolve return undefined when intermediate properties are undefined, rather than throwing a TypeError
...
Object.deleteUndefined = function(test, recurse) {
    for (var i in test) {
        if (test[i] === undefined) {
            delete test[i];
        } else if (recurse && typeof test[i] === 'object') {
            Object.deleteUndefined(test[i], recurse);
        }
    }
};